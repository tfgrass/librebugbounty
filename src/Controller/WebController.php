  ...
  <div class="about-dialog__panel" role="dialog" aria-modal="true" aria-labelledby="about-modal-title">
    ...
    <header class="about-hero">
      <div class="about-title">
        ...
        <div class="about-version">v1.0.0 (Scriptor)</div>
      </div>
    ...
    <section class="about-section">
      ...
      <p class="about-note">Work in progress: more vuln types, email notifications, a better vuln classifier/rule engine is planned, while the goal is to bring OpenBugBounty-style workflows into a local setup.</p>
