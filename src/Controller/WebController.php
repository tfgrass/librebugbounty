  ...
  <div class="about-dialog__panel" role="dialog" aria-modal="true" aria-labelledby="about-modal-title">
    ...
    <header class="about-hero">
      <div class="about-title">
        ...
        <div class="about-version">v0.1.0 (Scriptor)</div>
      </div>
      <p class="about-subtitle">Vibe-coded by tfgrass.</p>
      <div class="about-links" aria-label="Project links">
        <a class="about-link primary" href="https://github.com/tfgrass/librebugbounty" target="_blank" rel="noreferrer">GitHub</a>
        <a class="about-link secondary" href="https://www.flickr.com/photos/tkoschka/" target="_blank" rel="noreferrer">Flickr</a>
      </div>
    </header>
  </div>
</div>
